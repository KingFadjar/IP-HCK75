...
const { getCars, addCar, updateCar, deleteCar, rentCar, getCheapestCarRecommendation } = require('../controllers/carController');
...
// Endpoint untuk mendapatkan rekomendasi harga mobil termurah
router.get('/cheapest-recommendation', authenticateUser, getCheapestCarRecommendation);
